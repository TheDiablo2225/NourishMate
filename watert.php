...
h3 {
  ...
  .cupbtn {
    ...
    cursor : pointer;
        ...
        <body style = "background-color: #0e415a;">

            
   
       

        <div class="header" style = "background-color: #0e415a;">
            ...
            <div>
              <svg class="waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <g class="parallax">
                  ...
                  <use xlink:href="#gentle-wave" x="48" y="5" fill="rgba(88, 198, 242, 0.453)" />
...
<div style = "margin : 10px; padding-right:50px;">
    ...
    <button class="GFG dropbtn" 
    onclick="window.location.href = 'file:///C:/Users/HP/AppData/Local/Microsoft/Windows/INetCache/IE/IH1M7GNO/pr1.html';">    
    Home
    </button> 
    <button class="GFG dropbtn" 
    onclick="window.location.href = 'https://ide.geeksforgeeks.org';"> 
  ...
  <p class="text" style = "text-align : center; color :#fff">Select how many glasses of water that you have drank</p>
  <div style = "padding-left : 320px; ">
  <div class="cups">
      <div class="cup cup-small"><button class = "cupbtn">Glass 1</button></div>
      <div class="cup cup-small"><button class = "cupbtn">Glass 2</button></div>
      <div class="cup cup-small"><button class = "cupbtn">Glass 3</button></div>
      <div class="cup cup-small"><button class = "cupbtn">Glass 4</button></div>
      <div class="cup cup-small"><button class = "cupbtn">Glass 5</button></div>
      <div class="cup cup-small"><button class = "cupbtn">Glass 6</button></div>
      <div class="cup cup-small"><button class = "cupbtn">Glass 7</button></div>
      </div>
  </div>
  </div>
      <script >
